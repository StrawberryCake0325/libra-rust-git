...
Command Groups:
  ...
  Maintenance And Plumbing db, fsck, cat-file, hash-object, verify-pack, stats, rev-parse, rev-list, symbolic-ref, reflog, bisect
...
enum Commands {
    ...
    #[command(about = "Count file extensions in the current working directory")]
